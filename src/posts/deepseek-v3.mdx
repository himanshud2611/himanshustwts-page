...
![Andrej Karpathy on Deepseek v3](/dsv3/image.png)
...
![Attention architectures - Deepseek v2 paper - page 7](/dsv3/image7.png)

Attention architectures - Deepseek v2 paper - page 7
...
In MLA, they incorporate a super smart idea of forming matrices via a down and up projection. The distinction is instead of storing K and V in the KV cache, we can store a small sliver of C instead!
...
Sparse MOE layers are used instead of feed-forward-network (FFN) layers. These layers have a certain number of experts, and each expert is a neural net.
...
This is all for this blog. I hope you enjoyed reading it. Through this blog, we’ve delved deep into the concepts and mathematical foundations with intuition from the ground up.
...
[https://trite-song-d6a.notion.site/Deepseek-R1-for-Everyone-1860af77bef3806c9db5e5c2a256577d](https://www.notion.so/1860af77bef3806c9db5e5c2a256577d?)
